      ...
      '/guide/nestjs/': [
        {
          items: [
            ...
            {text: '模块', link: '/guide/nestjs/模块'},
            {text: '项目配置', link: '/guide/nestjs/项目配置'},
            {text: '控制器', link: '/guide/nestjs/控制器'},
            {text: 'prisma', link: '/guide/nestjs/prisma'},
            {text: '管道PIPE', link: '/guide/nestjs/管道PIPE'},
            {text: '表单验证', link: '/guide/nestjs/表单验证'},
            {text: '登录注册', link: '/guide/nestjs/登录注册'},
            {text: '身份认证', link: '/guide/nestjs/身份认证'},
            {text: 'CRUD', link: '/guide/nestjs/CRUD'},
            {text: '拦截器', link: '/guide/nestjs/拦截器'},
            {text: '文件上传', link: '/guide/nestjs/文件上传'},
            {text: '静态访问', link: '/guide/nestjs/静态访问'},
            {text: 'cors', link: '/guide/nestjs/cors'},
            {text: '响应', link: '/guide/nestjs/响应'},
            {text: '异常过滤器', link: '/guide/nestjs/异常过滤器'},
            {text: '高速缓存', link: '/guide/nestjs/高速缓存'},
            {text: '限流', link: '/guide/nestjs/限流'},
            {text: '原理理解', link: '/guide/nestjs/原理理解'},
          ]
        }
      ],
      '/guide/java/': [
