...
-- 只匹配小写 p
SELECT * FROM class WHERE description LIKE BINARY '%p%';
SELECT * FROM class WHERE LOWER(description) LIKE '%p%';

-- 只匹配大写 P
SELECT * FROM class WHERE description LIKE BINARY '%P%';
SELECT * FROM class WHERE UPPER(description) LIKE '%P%';
