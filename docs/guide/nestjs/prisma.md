...
使用 prisma 需要大量网络下载，所以建议使用 [nrm](https://doc.houdunren.com/soft/7.2 nrm.html) 设置合适的源，来提高下载速度。你可以通过[prisma](https://prisma.yoga/getting-started)官网或[nestjs文档](https://docs.nestjs.com/recipes/prisma)查看更多内容。
